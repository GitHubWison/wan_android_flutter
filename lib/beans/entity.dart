...
//////////////////////
class FavoriteArticleInfo {
  int curPage;
  List<FavoriteArticle> datas;
  int offset;
  bool over;
  int pageCount;
  int size;
  ...
  FavoriteArticleInfo.fromJson(Map<String, dynamic> json) {
    curPage = json['curPage'];
    if (json['datas'] != null) {
      datas = new List<FavoriteArticle>();
      json['datas'].forEach((v) {
        datas.add(new FavoriteArticle.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class FavoriteArticle {
  ...
  FavoriteArticle.fromJson(Map<String, dynamic> json) {
    author = json['author'];
    chapterId = json['chapterId'];
    chapterName = json['chapterName'];
    courseId = json['courseId'];
